// Assessment science rules — moved from lib/assessment-rules.ts
...
export const ASSESSMENT_SCIENCE = `## Teaduspõhised tagasiside reeglid (Science-based feedback rules)
